...
sudo docker build -t "${IMAGE_NAME}" --file="/vagrant/provision/docker/quorumMonitor/images/DockerfileClient" --no-cache /vagrant/provision/docker/quorumMonitor/images/
