...
sudo docker build -t "${IMAGE_NAME}" --file="/vagrant/provision/docker/quorumMonitor/images/DockerfileGeneralNodes" --no-cache /vagrant/provision/docker/quorumMonitor/images/
